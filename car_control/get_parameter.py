...
#     pygame.mixer.init()
#     pygame.mixer.music.load('./car_control/right.mp3')
#     pygame.mixer.music.play()
#     for _ in range(5):  # 闪烁5次
#         screen.fill((255, 255, 255))  # 白屏
#         pygame.display.flip()
...
#         text_rect = text.get_rect(center=(950, 1000))
#         screen.blit(text, text_rect)
#         image = pygame.image.load('./car_control/right.png')
#         screen.blit(image, (700, 200))
#         pygame.display.flip()
#         time.sleep(0.5)
...
#     pygame.mixer.init()
#     pygame.mixer.music.load('./car_control/go.mp3')
#     pygame.mixer.music.play()
#     for _ in range(5):  # 闪烁5次
#         screen.fill((255, 255, 255))  # 白屏
#         pygame.display.flip()
...
#         text_rect = text.get_rect(center=(950, 1000))
#         screen.blit(text, text_rect)
#         image = pygame.image.load('./car_control/go.png')
#         screen.blit(image, (700, 200))
#         pygame.display.flip()
#         time.sleep(0.5)
...
#     pygame.mixer.init()
#     pygame.mixer.music.load('./car_control/stop.mp3')
#     pygame.mixer.music.play()
#     for _ in range(5):  # 闪烁5次
#         screen.fill((255, 255, 255))  # 白屏
#         pygame.display.flip()
...
#         text_rect = text.get_rect(center=(950, 1000))
#         screen.blit(text, text_rect)
#         image = pygame.image.load('./car_control/stop.png')
#         screen.blit(image, (700, 200))
#         pygame.display.flip()
#         time.sleep(0.5)
