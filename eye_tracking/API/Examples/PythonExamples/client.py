...
def main():
    ...
    parser.add_argument(
        ...
        dest='out_dir',
        type=validate_file_path,
        default=os.path.expanduser("~/Documents/Smart Eye"),
    ...
    if args.mode == "can":
        receive_can_data(args.start_frame, args.stop_frame, args.vxlapi_path,
                         args.out_dir)
    else:
